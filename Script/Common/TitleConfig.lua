...
TitleConfig.Titles = {
    [1]  = { TextToGet = "战力达到：2万", BonusText = "攻击+1%\n生命+1%", Bonus = { AttackPercent = 1, HPPercent = 1 } },
    [2]  = { TextToGet = "战力达到：2亿", BonusText = "攻击+2%\n生命+2%", Bonus = { AttackPercent = 2, HPPercent = 2 } },
    [3]  = { TextToGet = "战力达到：1280亿", BonusText = "攻击+3%\n生命+3%", Bonus = { AttackPercent = 3, HPPercent = 3 } },
    [4]  = { TextToGet = "战力达到：180万亿", BonusText = "攻击+4%\n生命+4%", Bonus = { AttackPercent = 4, HPPercent = 4 } },
    [5]  = { TextToGet = "抽奖5次", BonusText = "攻击+5%\n生命+5%", Bonus = { AttackPercent = 5, HPPercent = 5 } },
    [6]  = { TextToGet = "抽奖10次", BonusText = "攻击+8%\n生命+8%", Bonus = { AttackPercent = 8, HPPercent = 8 } },
    [7]  = { TextToGet = "击败一万只怪物", BonusText = "攻击+3%\n生命+3%", Bonus = { AttackPercent = 3, HPPercent = 3 } },
