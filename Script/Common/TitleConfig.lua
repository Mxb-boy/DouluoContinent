...
TitleConfig.Titles = {
    ...
    [8]  = { Name = "翡翠山谷", TextToGet = "通关主线1", BonusText = "攻击+1%\n生命+1%", Bonus = { AttackPercent = 1, HPPercent = 1 } },
    [9]  = { Name = "荒古无双", TextToGet = "通关主线2", BonusText = "攻击+1.5%\n生命+1.5%", Bonus = { AttackPercent = 1.5, HPPercent = 1.5 } },
    [10] = { Name = "威震四海", TextToGet = "通关主线3", BonusText = "攻击+2%\n生命+2%", Bonus = { AttackPercent = 2, HPPercent = 2 } },
    [11] = { Name = "神山圣尊", TextToGet = "通关主线4", BonusText = "攻击+2.5%\n生命+2.5%", Bonus = { AttackPercent = 2.5, HPPercent = 2.5 } },
    [12] = { Name = "九天天罡", TextToGet = "通关主线5", BonusText = "攻击+3%\n生命+3%", Bonus = { AttackPercent = 3, HPPercent = 3 } },
