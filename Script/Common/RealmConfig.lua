...
RealmConfig.Levels = {
    ...
    [7] = {
        ...
        NeedItems = {
            ...
            { ItemID = ItemIDs.DHY, Count = 66, Name = "帝星印", IconPath = GetMaterialIconPath("dhy") },
        },
        DevConditionText = "帝星印：星帝令碎片掉落于所有万年星兽",
        SuccessRate = 48,
        GuaranteeFailCount = 5,
...
function RealmConfig.GetDisplayName(Config)
    ...
    local Stage = tostring(Config.Stage or "")
    local Name = tostring(Config.Name or "")
    if Name == "" then
        return Stage
    end
