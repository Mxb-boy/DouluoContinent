...
TalentConfig.Nodes = {
    ...
    [4] = {
        ID = 4,
        Name = "概率攻击增益",
        Description = "造成伤害时，有2%概率使攻击力提升10%。",
        Row = 3,
        Column = 2,
        Cost = 3,
        RequireID = 2,
    ...
    [5] = {
        ID = 5,
        Name = "概率生命恢复",
        Description = "造成伤害时，有2%概率恢复10%最大生命值。",
        Row = 3,
        Column = 6,
        Cost = 3,
        RequireID = 2,
    ...
    [6] = {
        ID = 6,
        Name = "概率暴击率增益",
        Description = "造成伤害时，有2%概率使暴击率提升10%。",
        Row = 3,
        Column = 10,
        Cost = 3,
        RequireID = 3,
    ...
    [7] = {
        ID = 7,
        Name = "概率暴伤增益",
        Description = "造成伤害时，有2%概率使暴击伤害倍率增加0.5。",
        Row = 3,
        Column = 14,
        Cost = 3,
        RequireID = 3,
    ...
    [11] = {
        ID = 11,
        Name = "愈合强化",
        Description = "使概率生命恢复的恢复量由10%提升至15%最大生命值。",
        Row = 4,
        Column = 7,
        Cost = 4,
        RequireID = 5,
    ...
    [13] = {
        ID = 13,
        Name = "暴击增幅",
        Description = "使概率暴击率增益的效果由10%提升至20%。",
        Row = 4,
        Column = 11,
        Cost = 4,
        RequireID = 6,
    ...
    [15] = {
        ID = 15,
        Name = "暴伤增幅",
        Description = "使概率暴伤增益的效果由0.5提升至1.0。",
        Row = 4,
        Column = 15,
        Cost = 4,
        RequireID = 7,
