...
local HIT_EFFECT_PATH = "Asset/Blueprint/Ma/QIANG/SKS/C98K_LZ.C98K_LZ"
...
function SKS:SetActiveGuns(GunCode)
...
function SKS:ActivateGuns(GunCode)
    return self:SetActiveGuns(GunCode)
end

function SKS:GetActiveGuns()
...
function SKS:TryDamageMonster(DamageBox, OtherActor)
