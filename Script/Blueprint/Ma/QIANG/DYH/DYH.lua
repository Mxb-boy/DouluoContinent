...
local HIT_EFFECT_PATH = "Asset/Blueprint/Ma/QIANG/DYH/C98K_LZ.C98K_LZ"
...
function DYH:SetActiveGuns(GunCode)
...
function DYH:SetActiveGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function DYH:OnRep_ActiveGunCode()
    self:SetActiveGuns(self.ActiveGunCode)
end

function DYH:ActivateGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function DYH:ActivateGuns(GunCode)
    return self:SetActiveGuns(GunCode)
end

function DYH:GetActiveGuns()
...
function DYH:TryDamageMonster(DamageBox, OtherActor)
...
function DYH:Box_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult)
    return self:TryDamageMonster(OverlappedComponent, OtherActor)
end

function DYH:Box_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
...
function DYH:GetReplicatedProperties()
