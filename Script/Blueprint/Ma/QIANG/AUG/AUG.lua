...
local HIT_EFFECT_PATH = "Asset/Blueprint/Ma/QIANG/AUG/AUG_LZ.AUG_LZ"
...
function AUG:SetActiveGuns(GunCode)
...
function AUG:SetActiveGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function AUG:OnRep_ActiveGunCode()
    self:SetActiveGuns(self.ActiveGunCode)
end

function AUG:ActivateGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function AUG:ActivateGuns(GunCode)
    return self:SetActiveGuns(GunCode)
end

function AUG:GetActiveGuns()
...
function AUG:TryDamageMonster(DamageBox, OtherActor)
...
function AUG:Box_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult)
    return self:TryDamageMonster(OverlappedComponent, OtherActor)
end

function AUG:Box_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
...
function AUG:GetReplicatedProperties()
