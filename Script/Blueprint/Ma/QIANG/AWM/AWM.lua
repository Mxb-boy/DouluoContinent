...
local HIT_EFFECT_PATH = "Asset/Blueprint/Ma/QIANG/AWM/C98K_LZ.C98K_LZ"
...
function AWM:SetActiveGuns(GunCode)
...
function AWM:SetActiveGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function AWM:OnRep_ActiveGunCode()
    self:SetActiveGuns(self.ActiveGunCode)
end

function AWM:ActivateGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function AWM:ActivateGuns(GunCode)
    return self:SetActiveGuns(GunCode)
end

function AWM:GetActiveGuns()
...
function AWM:TryDamageMonster(DamageBox, OtherActor)
...
function AWM:Box_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult)
    return self:TryDamageMonster(OverlappedComponent, OtherActor)
end

function AWM:Box_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
...
function AWM:GetReplicatedProperties()
