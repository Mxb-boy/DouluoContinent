...
---@field SKS_LZ UParticleSystemComponent
...
local HIT_EFFECT_PATH = "Asset/Blueprint/Ma/QIANG/S12K/C98K_LZ.C98K_LZ"
...
function S12K:ReceiveBeginPlay()
...
function S12K:SetActiveGuns(GunCode)
...
function S12K:SetActiveGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function S12K:OnRep_ActiveGunCode()
    self:SetActiveGuns(self.ActiveGunCode)
end

function S12K:ActivateGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function S12K:ActivateGuns(GunCode)
    return self:SetActiveGuns(GunCode)
end

function S12K:GetActiveGuns()
...
function S12K:TryDamageMonster(DamageBox, OtherActor)
...
function S12K:Box_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult)
    return self:TryDamageMonster(OverlappedComponent, OtherActor)
end

function S12K:Box_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
...
function S12K:GetReplicatedProperties()
