...
local HIT_EFFECT_PATH = "Asset/Blueprint/Ma/QIANG/QBZ/QBZ_LZ.QBZ_LZ"
...
function QBZ:SetActiveGuns(GunCode)
...
function QBZ:SetActiveGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function QBZ:ActivateGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function QBZ:ActivateGuns(GunCode)
    return self:SetActiveGuns(GunCode)
end

function QBZ:GetActiveGuns()
...
function QBZ:TryDamageMonster(DamageBox, OtherActor)
...
function QBZ:Box_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult)
    return self:TryDamageMonster(OverlappedComponent, OtherActor)
end

function QBZ:Box_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
