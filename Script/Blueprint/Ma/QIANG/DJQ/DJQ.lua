...
local HIT_EFFECT_PATH = "Asset/Blueprint/Ma/QIANG/DJQ/C98K_LZ.C98K_LZ"
...
function DJQ:SetActiveGuns(GunCode)
...
function DJQ:SetActiveGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function DJQ:OnRep_ActiveGunCode()
    self:SetActiveGuns(self.ActiveGunCode)
end

function DJQ:ActivateGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function DJQ:ActivateGuns(GunCode)
    return self:SetActiveGuns(GunCode)
end

function DJQ:GetActiveGuns()
...
function DJQ:TryDamageMonster(DamageBox, OtherActor)
...
function DJQ:Box_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult)
    return self:TryDamageMonster(OverlappedComponent, OtherActor)
end

function DJQ:Box_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
...
function DJQ:GetReplicatedProperties()
