...
local HIT_EFFECT_PATH = "Asset/Blueprint/Ma/QIANG/AK47/AK47_LZ.AK47_LZ"
...
function AK47:SetActiveGuns(GunCode)
...
function AK47:SetActiveGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function AK47:OnRep_ActiveGunCode()
    self:SetActiveGuns(self.ActiveGunCode)
end

function AK47:ActivateGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function AK47:ActivateGuns(GunCode)
    return self:SetActiveGuns(GunCode)
end

function AK47:GetActiveGuns()
...
function AK47:TryDamageMonster(DamageBox, OtherActor)
...
function AK47:Box_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult)
    return self:TryDamageMonster(OverlappedComponent, OtherActor)
end

function AK47:Box_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
