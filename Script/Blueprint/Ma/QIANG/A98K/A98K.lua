...
local HIT_EFFECT_PATH = "Asset/Blueprint/Ma/QIANG/A98K/C98K_LZ.C98K_LZ"
...
function A98K:ReceiveBeginPlay()
...
function A98K:SetActiveGuns(GunCode)
...
function A98K:SetActiveGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function A98K:OnRep_ActiveGunCode()
    self:SetActiveGuns(self.ActiveGunCode)
end

function A98K:ActivateGun(GunCode)
    return self:SetActiveGuns(GunCode)
end

function A98K:ActivateGuns(GunCode)
    return self:SetActiveGuns(GunCode)
end

function A98K:GetActiveGuns()
...
function A98K:TryDamageMonster(DamageBox, OtherActor)
...
function A98K:Box_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult)
    return self:TryDamageMonster(OverlappedComponent, OtherActor)
end

function A98K:Box_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
...
function A98K:GetReplicatedProperties()
