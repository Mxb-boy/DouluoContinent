---@class CB_1_C:Template_AvatarEquipment_Armor_LV3_Handle_C
--Edit Below--
local CB_1 = {} 
...
-- function CB_1:OnDurabilityChanged(OriginDurability, ChangedDurability)
--     CB_1.SuperClass.OnDurabilityChanged(self, OriginDurability, ChangedDurability);
-- end
...
-- function CB_1:HandlePickup(ItemContainer, PickupInfo, Reason)
--    return CB_1.SuperClass.HandlePickup(self, ItemContainer, PickupInfo, Reason)
-- end

--- func 处理物品的丢弃(服务端生效)
---@return bool @是否丢弃该物品, 返回true才会丢弃
-- function CB_1:HandleDrop(InCount, Reason)
--    return CB_1.SuperClass.HandleDrop(self, InCount, Reason)
-- end

--- func 处理物品的取出(服务端生效)
---@return number @可取出物品数量
-- function CB_1:HandleTake(TakeCount, TotalCount)
--    return CB_1.SuperClass.HandleTake(self, TakeCount, TotalCount)
-- end

--- func 处理物品的使用(服务端生效)
---@return bool @使用是否成功
-- function CB_1:HandleUse(Target, Reason)
--    return CB_1.SuperClass.HandleUse(self, Target, Reason) 
-- end

--- func 处理物品的取消使用(服务端生效)
---@return bool @取消使用是否成功
-- function CB_1:HandleDisuse(Reason)
--    return CB_1.SuperClass.HandleDisuse(self, Reason) 
-- end

--- func 尝试取消使用物品，仅尝试(服务端生效)
---@return bool @物品能否取消使用
-- function CB_1:HandleTryDisuse(Reason)
--    return CB_1.SuperClass.HandleTryDisuse(self, Reason)
-- end

--- func 处理物品的有效性(服务端生效)
-- function CB_1:HandleEnable(bEnable)
--    CB_1.SuperClass.HandleEnable(self, bEnable)
-- end

--- func 处理物品的清除(服务端生效)
---@return bool @清除物品是否成功
-- function CB_1:HanldeCleared()
--    return CB_1.SuperClass.HanldeCleared(self)
-- end
]]--
