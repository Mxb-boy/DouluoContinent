---@class Boss_5_C:BP_UGC_GenericMobPawn_Base_C
...
-- function Boss_5:ReceiveBeginPlay()
--     Boss_5.SuperClass.ReceiveBeginPlay(self)
-- end

-- function Boss_5:ReceiveTick(DeltaTime)
--     Boss_5.SuperClass.ReceiveTick(self, DeltaTime)
-- end

-- function Boss_5:ReceiveEndPlay()
--     Boss_5.SuperClass.ReceiveEndPlay(self) 
-- end

-- function Boss_5:GetReplicatedProperties()
--     return
-- end
...
-- function Boss_5:PreTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- ---@param DamageCauser AActor 伤害来源
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- function Boss_5:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- function Boss_5:PreOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- ---@return float 修改后的伤害值
-- function Boss_5:PostOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
function Boss_5:BPDie(KillingDamage, EventInstigator, DamageCauser, DamageEvent, DamageTypeID)
...
-- function Boss_5:OnEnterTagState_BP(DynamicState)
...
-- function Boss_5:OnLeaveTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function Boss_5:OnInterruptTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function Boss_5:OnBehaviorNotify_BP(NotifyMsg)
...
-- function Boss_5:OnTargetChange_BP(NewTarget, OldTarget)
