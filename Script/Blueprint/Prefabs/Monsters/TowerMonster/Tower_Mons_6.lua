...
function Tower_Mons_6:ReceiveBeginPlay()
    Tower_Mons_6.SuperClass.ReceiveBeginPlay(self)
    self.ShakingPlayers = {}
...
-- function Tower_Mons_6:ReceiveTick(DeltaTime)
--     Tower_Mons_6.SuperClass.ReceiveTick(self, DeltaTime)
-- end

-- function Tower_Mons_6:ReceiveEndPlay()
--     Tower_Mons_6.SuperClass.ReceiveEndPlay(self) 
-- end

-- function Tower_Mons_6:GetReplicatedProperties()
--     return
-- end
...
-- function Tower_Mons_6:PreTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- ---@param DamageCauser AActor 伤害来源
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- function Tower_Mons_6:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- function Tower_Mons_6:PreOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- ---@return float 修改后的伤害值
-- function Tower_Mons_6:PostOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- function Tower_Mons_6:OnEnterTagState_BP(DynamicState)
...
-- function Tower_Mons_6:OnLeaveTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function Tower_Mons_6:OnInterruptTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function Tower_Mons_6:OnBehaviorNotify_BP(NotifyMsg)
...
-- function Tower_Mons_6:OnTargetChange_BP(NewTarget, OldTarget)
    
-- end

function Tower_Mons_6:OutBox_OnComponentHit(HitComponent, OtherActor, OtherComp, NormalImpulse, Hit)
    return nil;
end

function Tower_Mons_6:InBox_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex,
...
function Tower_Mons_6:InBox_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
    return nil;
end

function Tower_Mons_6:OutBox_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex,
    bFromSweep, SweepResult)
    if not self:HasAuthority() then
        return
    end
...
function Tower_Mons_6:OutBox_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
    if not self:HasAuthority() then
        return
    end
