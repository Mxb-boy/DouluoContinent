---@class Tower_Mons_2_C:Tower_Mons_1_C
--Edit Below--
local Tower_Mons_2 = {}
...
function Tower_Mons_2:ReceiveBeginPlay()
    Tower_Mons_2.SuperClass.ReceiveBeginPlay(self)
    self.ShakingPlayers = {}
...
-- function Tower_Mons_2:ReceiveTick(DeltaTime)
--     Tower_Mons_2.SuperClass.ReceiveTick(self, DeltaTime)
-- end

-- function Tower_Mons_2:ReceiveEndPlay()
--     Tower_Mons_2.SuperClass.ReceiveEndPlay(self) 
-- end

-- function Tower_Mons_2:GetReplicatedProperties()
--     return
-- end
...
-- function Tower_Mons_2:PreTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- ---@param DamageCauser AActor 伤害来源
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- function Tower_Mons_2:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- function Tower_Mons_2:PreOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- ---@return float 修改后的伤害值
-- function Tower_Mons_2:PostOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
function Tower_Mons_2:BPDie(KillingDamage, EventInstigator, DamageCauser, DamageEvent, DamageTypeID)
    MonsterSpawnMgr.DisableMonsterCollision(self)
    Tower_Mons_2.SuperClass.BPDie(self, KillingDamage, EventInstigator, DamageCauser, DamageEvent, DamageTypeID)
...
-- function Tower_Mons_2:OnEnterTagState_BP(DynamicState)
...
-- function Tower_Mons_2:OnLeaveTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function Tower_Mons_2:OnInterruptTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function Tower_Mons_2:OnBehaviorNotify_BP(NotifyMsg)
...
-- function Tower_Mons_2:OnTargetChange_BP(NewTarget, OldTarget)
    
-- end

function Tower_Mons_2:OutBox_OnComponentHit(HitComponent, OtherActor, OtherComp, NormalImpulse, Hit)
    return nil;
end

function Tower_Mons_2:InBox_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex,
...
function Tower_Mons_2:InBox_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
    return nil;
end

function Tower_Mons_2:OutBox_OnComponentBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex,
    bFromSweep, SweepResult)
    if not self:HasAuthority() then
        return
    end
...
function Tower_Mons_2:OutBox_OnComponentEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex)
    if not self:HasAuthority() then
        return
    end
