...
-- function BaseMonsaa:ReceiveBeginPlay()
--     BaseMonsaa.SuperClass.ReceiveBeginPlay(self)
-- end

-- function BaseMonsaa:ReceiveTick(DeltaTime)
--     BaseMonsaa.SuperClass.ReceiveTick(self, DeltaTime)
-- end

-- function BaseMonsaa:ReceiveEndPlay()
--     BaseMonsaa.SuperClass.ReceiveEndPlay(self) 
-- end

-- function BaseMonsaa:GetReplicatedProperties()
--     return
-- end
...
-- function BaseMonsaa:PreTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- ---@param DamageCauser AActor 伤害来源
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- function BaseMonsaa:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- function BaseMonsaa:PreOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- ---@return float 修改后的伤害值
-- function BaseMonsaa:PostOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- function BaseMonsaa:OnEnterTagState_BP(DynamicState)
...
-- function BaseMonsaa:OnLeaveTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function BaseMonsaa:OnInterruptTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function BaseMonsaa:OnBehaviorNotify_BP(NotifyMsg)
...
-- function BaseMonsaa:OnTargetChange_BP(NewTarget, OldTarget)
