...
-- function BaseMonsJiChu:ReceiveTick(DeltaTime)
--     BaseMonsJiChu.SuperClass.ReceiveTick(self, DeltaTime)
-- end

-- function BaseMonsJiChu:ReceiveEndPlay()
--     BaseMonsJiChu.SuperClass.ReceiveEndPlay(self) 
-- end

-- function BaseMonsJiChu:GetReplicatedProperties()
--     return
-- end
...
-- function BaseMonsJiChu:PreTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- ---@param DamageCauser AActor 伤害来源
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- function BaseMonsJiChu:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- function BaseMonsJiChu:PreOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- ---@return float 修改后的伤害值
-- function BaseMonsJiChu:PostOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- function BaseMonsJiChu:OnEnterTagState_BP(DynamicState)
...
-- function BaseMonsJiChu:OnLeaveTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function BaseMonsJiChu:OnInterruptTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function BaseMonsJiChu:OnBehaviorNotify_BP(NotifyMsg)
...
-- function BaseMonsJiChu:OnTargetChange_BP(NewTarget, OldTarget)
    
-- end

return BaseMonsJiChu
