...
function BaseMons:PreTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
    self:GetBlackBoardComponent():SetValueAsBool('bHit', true)
end
...
-- function BaseMons:PreOverrideDamageValue(Damage, DamageType, EventInstigator, DamageCauser, Hit)
--     return Damage
-- end
...
-- ---@param HitF HitResult 伤害上下文
-- ---@return float 修改后的伤害值
-- function BaseMons:PostOverrideDamageValue(Damage, DamageType, EventInstigator, DamageCauser, Hit)
--     return Damage
-- end
...
-- function BaseMons:OnTargetChange_BP(OldTarget, NewTarget)
