---@class SignInEvent_Weekly_Item_UIBP_C:UUserWidget
---@field ConfirmButton UNewButton
---@field DayText UTextBlock
---@field HighLightSwitcher UWidgetSwitcher
---@field Icon UImage
...
function SignInEvent_Weekly_Item_UIBP:Construct()
...
function SignInEvent_Weekly_Item_UIBP:Refresh(EventID, DayIndex, SupplementDay)
    ...
    local ItemData = Common.GetObjectDatas()[Awards[DayIndex].ItemID];
    ...
    if DayIndex % 7 == 0 and Config.Highlight7thDay == true then
        ...
        self.HighLightSwitcher:SetActiveWidgetIndex(0);
    end
...
function SignInEvent_Weekly_Item_UIBP:OnPress()
...
function SignInEvent_Weekly_Item_UIBP:OnRelease()
...
return SignInEvent_Weekly_Item_UIBP
