---@class Lottery_Tab_Mode1_UIBP_C:UUserWidget
...
---@field Image_DrawUI UImage
---@field Image_Money UImage
---@field Lottery_Button_One_UIBP Lottery_Button_One_UIBP_C
---@field Lottery_Button_Ten_UIBP Lottery_Button_Ten_UIBP_C
---@field Lottery_Currency_01 Lottery_Currency_UIBP_C
---@field Lottery_Currency_02 Lottery_Currency_UIBP_C
---@field Lottery_Currency_03 Lottery_Currency_UIBP_C
---@field Lottery_GetBoxItem_Bar_UIBP Lottery_GetBoxItem_Bar_UIBP_C
---@field Lottery_IconItem_03 Lottery_IconItem_UIBP_C
---@field Lottery_IconItem_UIBP_01 Lottery_IconItem_UIBP_C
---@field Lottery_IconItem_UIBP_02 Lottery_IconItem_UIBP_C
---@field Lottery_IconItem_UIBP_04 Lottery_IconItem_UIBP_C
---@field Lottery_IconItem_UIBP_05 Lottery_IconItem_UIBP_C
---@field Lottery_IconItem_UIBP_06 Lottery_IconItem_UIBP_C
---@field Lottery_IconItem_UIBP_07 Lottery_IconItem_UIBP_C
...
local Lottery_Tab_Mode1_UIBP = { bInitDoOnce = false } 

function Lottery_Tab_Mode1_UIBP:Construct()
    self:InitBindEvent();
...
-- function Lottery_Tab_Mode1_UIBP:Tick(MyGeometry, InDeltaTime)

-- end

function Lottery_Tab_Mode1_UIBP:Destruct()
...
function Lottery_Tab_Mode1_UIBP:InitBindEvent()
...
function Lottery_Tab_Mode1_UIBP:InitUI(LotteryID, ShowAwardNum, IsShowExchange, IsShowGiftProgress, IsUseModeOne)
    ...
    if LotteryData then
        ...
        if IsUseModeOne == ELotteryMainUIType.Default then
            self.CanvasPanel_Upload:SetVisibility(ESlateVisibility.Collapsed);
            self.HorizontalBox_3:SetVisibility(ESlateVisibility.SelfHitTestInvisible);
            self.CanvasPanel_bg:SetVisibility(ESlateVisibility.SelfHitTestInvisible);
            self:ShowAward(LotteryID, ShowAwardNum);
        elseif IsUseModeOne == ELotteryMainUIType.TwoDimensionBg then
            self.CanvasPanel_Upload:SetVisibility(ESlateVisibility.SelfHitTestInvisible);
            self.HorizontalBox_3:SetVisibility(ESlateVisibility.Collapsed);
            self.CanvasPanel_bg:SetVisibility(ESlateVisibility.Collapsed);
        end
...
function Lottery_Tab_Mode1_UIBP:RefreshTodayDrawTimes(TodayDrawTimes)
    if self.IsShowTodayDrawTimes then
        self.TextBlock_CurrentNum:SetText(tostring(TodayDrawTimes));
    end
end

function Lottery_Tab_Mode1_UIBP:RefreshTotalDrawTimes(TotalDrawTimes)
    if self.IsShowTotalDrawTimes then
        self.Lottery_GetBoxItem_Bar_UIBP:RefreshTotalDrawTimes(TotalDrawTimes);
    end
end

function Lottery_Tab_Mode1_UIBP:InitCurrencyBar()
...
function Lottery_Tab_Mode1_UIBP:GetRecordBtnClick()
    -- 获奖记录界面
    LotteryManager:OpenLotteryAwardRecord();
end

function Lottery_Tab_Mode1_UIBP:AwardPreviewBtnClick()
    -- 奖品预览界面
    LotteryManager:OpenLotteryAwardPreview();
end

function Lottery_Tab_Mode1_UIBP:ExchangeShopBtnClick()
    -- 碎片兑换界面
    LotteryManager:OpenLotteryExchange();
end

function Lottery_Tab_Mode1_UIBP:ExplainBtnClick()
    -- 抽奖说明界面
    LotteryManager:OpenLotteryExplanation(self.LotteryExplanation);
end

function Lottery_Tab_Mode1_UIBP:RefreshUI()
    -- 抽奖后立即刷新
    -- 1. 抽奖所消耗的货币数发生变化(开启首次抽取折扣)
    -- 2. 今日已抽取次数
    -- 3. 买赠礼包进度
    -- 4. 货币变化
end

function Lottery_Tab_Mode1_UIBP:ShowAward(LotteryID, ShowAwardNum)
    ...
    print(string.format("Lottery_Tab_Mode1_UIBP:ShowAward ItemNum: %d ShowNum: %d", totalAwardNum, ShowAwardNum));
...
function Lottery_Tab_Mode1_UIBP:ShowExchangeButton(IsShow)
...
function Lottery_Tab_Mode1_UIBP:RefreshExchangeCurrencyNum()
...
function Lottery_Tab_Mode1_UIBP:ShowGiftProgress(IsShow)
    if IsShow then
